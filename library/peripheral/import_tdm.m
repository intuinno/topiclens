function tmp = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   TMP = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   TMP = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   tmp = importfile('tmp.mtx', 2, 1347);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2015/12/26 17:00:45
