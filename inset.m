function [h_main, h_inset]=inset(main_handle, inset_handle,inset_size, x, y)
...
set(h_inset,'Position', [ax(1)+abs((-30-x)/70)-0.5*inset_size ax(2)+abs((-25-y)/60)-0.5*inset_size inset_size inset_size])
