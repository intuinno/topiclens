...
var subtsnejs = subtsnejs || { REVISION: 'ALPHA' };
...
(function(global) {
  ...
  var selectlm = function(n, m){
    ...
    while (0 !== currentIndex) {
      ...
      temporaryValue = yidx[currentIndex];
      yidx[currentIndex] = yidx[randomIndex];
      yidx[randomIndex] = temporaryValue;  
    }
    for (var j=0; j<m ; j++){
      idx.push(yidx[j]);
    }
  ...
  subtSNE.prototype = {
    ...
    costGrad: function(Y, sub_k, cl_idx_sub, ctrary) {
      ...
      for(var i=0;i<N;i++) {
        ...
        if (tmp_idx_for_i<m && landmark[tmp_idx_for_i]==i){
  ...
  global.subtSNE = subtSNE; // export tSNE class
})(subtsnejs);
...
(function(lib) {
  ...
  if (typeof module === "undefined" || typeof module.exports === "undefined") {
    window.subtsnejs = lib; // in ordinary browser attach library to window
  } else {
