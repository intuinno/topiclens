    ...
    angular.module('myApp.controllers')
        .controller('DemoCtrl', ['$scope', '$q','$window',
            function($scope, $q, $window) {
               ...
               $scope.changeActiveDataVisPapers = function() {

                    resetTutMsg();


                    $scope.activeData = 'VIS papers';

                    d3.csv('data/vispapers.csv', function(error, tdata) {
                        var count = 0;
                        ...
                        index = $scope.nomaConfig.dims.indexOf('filenumber');
                        $scope.nomaConfig.dims.splice(index, 1);
                ...
                $scope.changeActiveDataVisPapers();
